        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="texto">Registrar Trasferencias</h5>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form class="form-horizontal" method="POST" action="{{ route('cibers.store') }}" accept-charset="utf-8" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('ebanco') ? ' has-error' : '' }}">
                                    <label for="ebanco" class="col-md-12 control-label">Banco a retirar</label>

                                    <div class="col-md-12">
                                        <select id="ebanco" class="form-control" name="ebanco" value="{{ old('ebanco') }}" required autofocus>
                                        ...
                                        @if ($errors->has('ebanco'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('ebanco') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group{{ $errors->has('idbanco') ? ' has-error' : '' }}">
                                    <label for="idbanco" class="col-md-12 control-label">Banco a transferir</label>
