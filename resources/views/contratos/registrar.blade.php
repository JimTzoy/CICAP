                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('numerocliente') ? ' has-error' : '' }}">
                                <label for="numerocliente" class="col-md-12 control-label" >Numero Cliente <a href="#" class="fas fa-question-circle" data-toggle="popover" data-trigger="focus" title="Numero cliente" data-content="El numero de cliente son los ultimos digitos despues del punto de la ip de antena"></a></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <label for="ipcliente" class="col-md-12 control-label">IP Cliente <a href="#" class="fas fa-question-circle" data-toggle="popover" data-trigger="focus" title="IP cliente" data-content="El IP que debe de ingresar es el ip que le asigno a al moden o router"></a></label>
